...
public:
     ...
     void ICR4noH(size_t& ULS, const NbrsTable& nbrs,  mt19937& mt);
...
/*FOLLOWING VERSION FOR HYPERUNIFORM*/

template<size_t L>
void LightLadder<L>::ICR4noH(size_t& ULS, const NbrsTable& nbrs,  mt19937& mt)
{
    //cout<<"Calling .OneICR4noH() method: \n" <<endl;
...
///////////////////////////////////////////////////////////////////////////////////////////*/
    ...
    if(NACT==0){
      ...
      while(NACT>0&& (count<ULS)) //<---HAD ++j PREVIOUS VERSIONS. 
      {
