...
int main(int argc, char *argv[])
{
   ...
   string parameters="R4L10^4_N8110_2^5_NT1";        
   string wildCard1="SummVECR4L10^4_N8110_2^5_NT1_123_";
   string wildCard2="hmeanAvgeR4L10^4_N8110_2^5_NT1_123_";
   
   string file1Name=wildCard1;
   string file2Name=wildCard2;
   string taskIDstr="1";
   
   parameters=parameters+"_on"+numberTasksStr+"_tasks";
